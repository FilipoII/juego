...
namespace Game_of_Drones
{
    class Animation
    {
        ...
        public void Update(GameTime gameTime,Vector2 pers)
        {
	        ...
	        destinationRect = new Rectangle(
		        (int)pers.X - (int)(FrameWidth * scale) / 2,
		        (int)pers.Y - (int)(FrameHeight * scale) / 2,
